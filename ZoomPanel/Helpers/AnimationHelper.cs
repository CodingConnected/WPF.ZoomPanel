...
namespace CodingConnected.ZoomPanel.Helpers
{
    ...
    internal static class AnimationHelper
    {
        ...
        /// dependency property.
        /// </summary>
        public static void StartAnimation(UIElement animatableElement, DependencyProperty dependencyProperty, double toValue, double animationDurationSeconds, bool useAnimations) => StartAnimation(animatableElement, dependencyProperty, toValue, animationDurationSeconds, null, useAnimations);
