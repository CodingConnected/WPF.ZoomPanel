...
namespace CodingConnected.ZoomPanel
{
    public partial class ZoomPanel
    {
        ...
        /// </summary>
        public ICommand FillCommand => _fillCommand ??= new RelayCommand(() =>
        {
            SaveZoom();
        ...
        /// </summary>
        public ICommand FitCommand => _fitCommand ??= new RelayCommand(() =>
        {
            SaveZoom();
        ...
        /// </summary>
        public ICommand ZoomInCommand => _zoomInCommand ??= new RelayCommand(() =>
            {
        ...
        /// </summary>
        public ICommand ZoomOutCommand => _zoomOutCommand ??= new RelayCommand(() =>
             {
                 DelayedSaveZoom1500Miliseconds();
        ...
        public ICommand ZoomPercentCommand
            => _zoomPercentCommand ??= new RelayCommand<double>(value =>
            {
                SaveZoom();
        ...
        public ICommand ZoomRatioFromMinimumCommand
            => _zoomRatioFromMinimumCommand ??= new RelayCommand<double>(value =>
            {
                SaveZoom();
        ...
        {
            _zoomPercentCommand?.NotifyCanExecuteChanged();
