...
namespace CodingConnected.ZoomPanel
{
    /// <summary>
    /// This is an extension to the ZoomAndPanControol class that implements the
    /// IScrollInfo interface properties and functions.
    ///
    /// IScrollInfo is implemented to allow ZoomAndPanControl to be wrapped (in
    /// XAML) in a ScrollViewer. IScrollInfo allows the ScrollViewer and
    /// ZoomAndPanControl to communicate important information such as the
    /// horizontal and vertical scrollbar offsets.
    ///
    /// There is a good series of articles showing how to implement IScrollInfo
    /// starting here: http://blogs.msdn.com/bencon/archive/2006/01/05/509991.aspx
    /// </summary>
    public partial class ZoomPanel
    {
        ...
        /// <summary>
        /// Reference to the ScrollViewer that is wrapped (in XAML) around the
        /// ZoomAndPanControl. Or set to null if there is no ScrollViewer.
        /// </summary>
        ...
        /// <summary>
        /// Don't handle mouse wheel input from the ScrollViewer, the mouse
        /// wheel is used for zooming in and out, not for manipulating the scrollbars.
        /// </summary>
